...
// ✅ logoutAdmin ফাংশন ইমপোর্ট করা হলো
...
function setupEvents() {
    ...
    // ✅ logoutBtn ইভেন্ট যোগ করা হলো
    document.getElementById("logoutBtn")?.addEventListener("click", async () => {
        await logoutAdmin();              // auth.js থেকে ইমপোর্ট করা ফাংশন
        closeModal("loginModal");        // মডেল বন্ধ
        showToast("লগআউট করা হয়েছে");
        // watchAuth স্বয়ংক্রিয়ভাবে UI আপডেট করবে
    });
