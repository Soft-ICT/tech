...
/* =========================================
   Browser Back (Fixed for All Search)
========================================= */
...
/* =========================================
   All Search Functionality (Updated for Back Navigation)
========================================= */
...
function activateAllSearchUI() {
    ...
    if (btn) btn.textContent = "📁 Categories";
...
function closeAllSearchUI() {
    ...
    if (btn) btn.textContent = "🌐 All Search";
