...
// সংখ্যাগুলো প্রথমে এবং নামগুলো বর্ণানুক্রমিকভাবে সাজানোর কাস্টম সর্ট ফাংশন
...
function renderCategories(searchVal = "") {
    ...
    categoriesToShow = sortItemsBySmartCriteria(categoriesToShow);
    list.innerHTML = "";
...
function renderCategoryDetails(searchVal = "") {
    ...
    subCategories = sortItemsBySmartCriteria(subCategories);
    ...
    // হেডারগুলো যেভাবে সেভ করা হয়েছে সেই ক্রমানুসারে থাকবে (স্মার্ট সর্ট বাদ দেওয়া হয়েছে)
    ...
    headers.forEach(header => {
        ...
        // শুধুমাত্র হেডারের ভেতরের ডাটাগুলো স্মার্ট সর্ট হবে
