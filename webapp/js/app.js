...
function closeHeaderSearch() {
    ...
    if (searchBox && appTitle) {
        ...
        // সার্চ বন্ধ হলে বর্তমান পেজের স্টেট অনুযায়ী আইকন সেট করা
...
function showCategoryView(id) {
    ...
    // ২. মেনু আইকনের বদলে ব্যাক বাটন অন করা
    setNavState(true);
...
function showMainDashboardView(updateHistory = true) {
    ...
    // ১. মেন পেজে ফেরত আসলে মূল টাইটেল "Police Phonebook" রিসেট করা
    const appTitle = document.getElementById("appTitle");
    if (appTitle) {
        appTitle.textContent = "Police Phonebook";
    }

    // ২. মেনু আইকন ফিরিয়ে আনা
    setNavState(false);

    // ৩. সাব-টুলবার পুনঃরায় শো করা
    const subToolbar = document.querySelector(".sub-toolbar") || document.getElementById("subToolbar") || document.getElementById("allSearchBtn");
    if (subToolbar) {
