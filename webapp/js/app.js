...
/* =========================================
   EVENTS SETUP (Safe Elements Selection)
========================================= */
...
function setupEvents() {
    ...
    document.getElementById("emptyAddBtn")?.addEventListener("click", openAddCategory);
    document.getElementById("addSubCategoryBtn")?.addEventListener("click", openAddCategory);
...
function renderCategories() {
    ...
    // সার্চ ফিল্টারিং না থাকলে ড্যাশবোর্ডে শুধু Root Category দেখাবে
    if (!search) {
    ...
    categories.forEach(category => {
        ...
        card.innerHTML = `
            <div class="category-top">
                ...
                <div class="category-menu">
                    <button class="small-btn" title="Edit" data-action="edit"><i class="fa-solid fa-pen"></i></button>
                    <button class="small-btn" title="Delete" data-action="delete"><i class="fa-solid fa-trash"></i></button>
                </div>
            </div>
        `;
        ...
        card.addEventListener("click", event => {
            ...
            const action = targetBtn ? targetBtn.dataset.action : null;
...
function openCategory(id) {
    ...
    if (category.parentId) {
        titleContainer.innerHTML = `
            <span id="backCatBtn" style="cursor:pointer; margin-right:8px;" title="Back"><i class="fa-solid fa-arrow-left"></i></span>
...
function renderCategoryDetails() {
    ...
    if (subCategories.length > 0) {
        ...
        subSec.innerHTML = `<h3 style="margin-bottom:10px; font-size:16px;"><i class="fa-solid fa-folder-open"></i> Sub-Categories</h3>`;
    ...
    headers.forEach(header => {
        ...
        section.innerHTML = `
            <div class="header-title">
                <span><i class="fa-solid fa-tag"></i> ${escapeHTML(header.title)}</span>
                <button class="small-btn" title="Delete Header"><i class="fa-solid fa-trash"></i></button>
            </div>
    ...
    if (noHeaderData.length > 0) {
        ...
        section.innerHTML = `
            <div class="header-title">
                <span><i class="fa-solid fa-file-lines"></i> সাধারণ Data</span>
            </div>
            <div class="header-data"></div>
        `;
