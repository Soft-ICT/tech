...
function setNavState(searchActive) {
    ...
    const backIcon = document.getElementById("backIcon") || document.getElementById("searchBackBtn");
...
function openHeaderSearch() {
    const searchBoxWrapper = document.getElementById("headerSearchBox") || document.getElementById("searchBox");
    const appTitle = document.getElementById("appTitle") || document.getElementById("topbarTitle");
    const searchBtn = document.getElementById("searchBtn") || document.getElementById("searchToggleBtn");

    if (searchBoxWrapper && appTitle) {
...
function setupEvents() {
    ...
    // Navigation Toggle Button Handling (Menu/Back)
    const navBtn = document.getElementById("navToggleBtn") || document.getElementById("searchBackBtn");
    ...
    const searchTrigger = document.getElementById("searchBtn") || document.getElementById("searchToggleBtn");
...
/* =========================================
   All Search Functionality (Fixed UI & Rendering)
========================================= */
...
function renderAllSearch() {
    ...
    if (allData.length === 0) {
        container.innerHTML = `<div style="text-align:center; padding: 40px 15px; color: var(--text-muted); font-size: 16px;">🔍 কোনো তথ্য পাওয়া যায়নি</div>`;
        return;
    }
...
function showCategoryView(id, pushState = true) {
