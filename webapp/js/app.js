...
async function loadDatabase() {
    ...
    try {
        ...
        showToast(
            "ফায়ারবেস থেকে ডাটা লোড করা যায়নি"
        );
    }
}
...
async function saveDatabase() {
    ...
    if (window.currentUserRole !== "admin") {
        ...
        showToast(
            "শুধুমাত্র Admin পরিবর্তন করতে পারবেন"
        );
...
function openCategory(id) {
    ...
    document
        .getElementById("mainDashboardView")
        ?.classList.add("hidden");


    document
        .getElementById("categoryDetailsView")
    ...
    if (subtitle) {
        ...
        subtitle.textContent =
            `${headersCount} Header • ${dataCount} Data`;
    }
...
/* =========================================================
   ...
   Data:
       data_CATEGORY_ID_HEADER_ID

   ফলে কোনো PIN scope অন্য scope-এর সাথে
   কখনো সংঘর্ষ করবে না।
========================================================= */
...
function normalizeCategoryPins() {
    ...
    const pinned =
        database.categories
            ...
            .sort(
                (a, b) =>
                    (Number(a.pinOrder) || 999999999) -
                    (Number(b.pinOrder) || 999999999)
            );
...
async function deleteCategory(id) {
    ...
    if (
        !confirm(
            "আপনি কি নিশ্চিত এই Category ডিলিট করতে চান? এর ভেতরের সব ডাটা মুছে যাবে!"
        )
    ) return;
...
function renderCategories() {
    ...
    if (countElement) {
        ...
        countElement.textContent =
            `${categoriesToShow.length}টি Category`;
    }
    ...
    if (
        ...
        container.innerHTML =
            `<p style="text-align:center;color:gray;margin-top:30px">
                এটি একটি খালি ক্যাটাগরি।
                সাব-ক্যাটাগরি, হেডার অথবা ডাটা যোগ করুন।
             </p>`;
    }
}
...
function createDataCardElement(
    ...
    dataEl.innerHTML = `
        ...
        <div>
            ...
            <p
                style="margin:4px 0 0;font-size:13px;color:#555"
            >
...
async function deleteHeader(id) {
    ...
    if (
        !confirm(
            "এই Header ডিলিট করবেন? এর Data সাধারণ Data-তে চলে যাবে।"
        )
    )
        return;
...
async function confirmMoveData() {
    ...
    if (
        ...
        /*
          Scope পরিবর্তন হচ্ছে।
          তাই পুরোনো PIN সরিয়ে নতুন scope-এ
          PIN collision হতে দেওয়া হবে না।
        */
        ...
        showToast(
            "Data সফলভাবে স্থানান্তর করা হয়েছে"
        );
    }
