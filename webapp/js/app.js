...
// নতুন নোটিশ সিস্টেম ইমপোর্ট করা হলো (ফোল্ডার পাথ ঠিক রাখা হয়েছে)
import {
    initNoticeSystem
} from "./notice.js";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // নতুন নোটিশ সিস্টেম ইনিশিয়ালাইজ করা হলো
    initNoticeSystem();
...
function activateAllSearchUI() {
    ...
    // অল সার্চ মোডে গেলে অ্যাড ক্যাটাগরি বাটনটি হাইড করা হবে (সমস্যা ২ সমাধান)
...
function closeAllSearchUI() {
    ...
    // মেইন ভিউতে ফিরে আসলে অ্যাডমিন রোল অনুযায়ী অ্যাড ক্যাটাগরি বাটন কন্ট্রোল হবে
    updateAdminUI();
...
/* =========================================
   Create Data Card (Clean & Fixed Layout)
========================================= */
...
/* =========================================
   Data Details Page (Fixed Layout & Verification Control)
========================================= */
...
function customConfirm(message, title = "নিশ্চিতকরণ", confirmText = "হ্যাঁ, মুছুন") {
    return new Promise((resolve) => {
        ...
        const cancelBtn = document.getElementById("confirmCancelBtn"); // Fixed ID mapping if any, or matches existing
