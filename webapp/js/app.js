...
function setupEvents() {
    ...
    // সুরক্ষিত এবং ফিক্সড লগআউট ইভেন্ট লিসেনার
    document.getElementById("logoutBtn")?.addEventListener("click", async () => {
        try {
            ...
            console.log("Firebase logout error (bypassed):", err);
        }

        // লোকাল স্টেট তাৎক্ষণিকভাবে রিসেট করা
        window.currentUser = null;
        window.currentUserRole = "guest";
        ...
        if (searchInput && searchInput.value === "admin@jr") {
            searchInput.value = "";
        }
